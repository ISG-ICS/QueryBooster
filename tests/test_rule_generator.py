...
def test_parse_validator_14():
  ...
  success, errormessage, index = RuleGenerator.parse_validate(pattern, rewrite)
  assert False == success
  assert "mismatching brackets" in errormessage
  assert index == 6

  #incorrect brackets
  def test_parse_validator_15():
